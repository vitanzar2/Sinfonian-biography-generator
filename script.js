...
const PRONOUNS = { he: { subj: "he", obj: "him", poss: "his" }, she: { subj: "she", obj: "her", poss: "her" }, they: { subj: "they", obj: "them", poss: "their" }, name: null };
...
function pWord(name, key) { const mode = fields.pronouns.value; return mode === "name" ? name : PRONOUNS[mode][key]; }
...
async function buildPdfBytes() {
  ...
  const box = { x: 50, topY: 700, bottomY: 70, maxWidth: 510 };
  ...
  page.drawText(title, { x: 50, y: 740, size: 20, font: bold });
  let y = box.topY;
